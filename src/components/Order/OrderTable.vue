            ...
            <template #grid="slotProps">
                <div class="grid grid-cols-12 gap-4">
                    <div v-for="(item, index) in slotProps.items" :key="index" class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-4 p-2">
                        <div class="relative overflow-hidden p-6 border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded flex flex-col hover:cursor-pointer"
                                ...
                                <div class="flex flex-row">
                                    <div class="w-full">
                                        <div class="flex flex-row w-full h-fit">
                                            <h class="w-3/4 font-bold text-2xl text-lime-600 dark:text-surface-400">{{ item.owner?.fullName }}</h>
                                        </div>
                                        <div class="flex flex-row">
