  ...
  <div v-if="isNumberEnterStep" class="flex flex-col items-center justify-center h-screen bg-pink-100 p-4 md:p-8">
    ...
    <div class="flex flex-col md:flex-row items-center w-full gap-8">
      ...
      <div class="flex flex-col items-center w-full md:w-1/2">
        ...
        <div class="grid content-center grid-cols-3 gap-4">
          ...
          <Button @click="nextAction" rounded raised
            class="custom-icon-button no-border text-4xl transition duration-150"
    ...
    <footer class="mt-6 text-sm text-gray-600 text-center max-w-xs">
      <label class="flex items-center space-x-2">
        ...
        <span>Mit dem Check-in erklären Sie sich mit unserer Datenschutzrichtlinie und den Geschäftsbedingungen des
          Geschäfts einverstanden.</span>
      </label>
    </footer>
  </div>
