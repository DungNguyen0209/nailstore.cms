...
<template>
  <LayoutAuthenticated>
    <SectionMain>
      <Dialog
        @hide="refresh"
        v-model:visible="isCreateNewUser"
        modal
        header="Edit Profile"
        :style="{ width: '45rem' }"
      >
        ...
        <div>
          ...
          <div class="flex items-center gap-4 mb-4 h-2">
            <label
              v-if="password.length > 0 && newUser.password != confirmPassword"
              class="w-full text-sm"
              >You must enter a correct confirm password.</label
            >
          </div>
        </div>
        <template #footer>
          ...
          <Button
            ...
            outlined
            severity="secondary"
            @click="() => (isConfirmCreateNewUser = true)"
            autofocus
          />
        </template>
      </Dialog>
      ...
      >
        ...
        <div v-if="selectedTab === 1">
          ...
          <div class="flex items-center gap-4 mb-2">
            ...
            >
              <template #dropdownicon>
                <i
                  v-if="Boolean(!selectAccount.role)"
                  :class="dropDown?.clicked ? 'pi pi-angle-down' : 'pi pi-align-justify'"
                ></i>
                <i
                  v-else
        ...
        <div v-if="selectedTab === 2">
          ...
          <div class="flex items-center gap-4 mb-4 h-2">
            <label v-if="password.length > 0 && password != confirmPassword" class="w-full text-sm"
              >You must enter a correct confirm password.</label
            >
          </div>
        </div>
        <template #footer>
          ...
          <Button
            ...
            outlined
            severity="secondary"
            @click="saveDetailInformation"
            autofocus
          />
        </template>
      </Dialog>
      <Dialog
        v-model:visible="isConfirmDelete"
        modal
      ...
      <Dialog
        v-model:visible="isConfirmCreateNewUser"
        modal
        header="Confirm Delete"
        :style="{ width: '20vw' }"
      >
                ...
                <div class="flex sm:flex-row flex-col text-center gap-2">
                  ...
                  <div class="sm:w-2/6 w-full flex flex-row gap-2">
                    ...
                    <span
                      ...
                      class="text-wrap text-center content-center"
