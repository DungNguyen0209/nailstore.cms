...
import { Sidebar, Tag, Button, DataTable, Column, Select, FloatLabel, MultiSelect, ConfirmPopup, Card, DataView, ScrollPanel, Checkbox  } from 'primevue'
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-row w-full ml-4 gap-4">
                                ...
                                <span class="text-gray-800 pb-0.5 font-thin">{{ reflectSelectedOrder.order.ownerPhone }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="flex mt-4">
                        <div class="flex flex-col w-full ml-4 gap-1">
                            ...
                            <span class="text-gray-800 font-thin">{{ reflectSelectedOrder.order.ownerEmail }}</span>
                        </div>
                        <div class="flex flex-col w-full ml-4 gap-1">
                            <span>Check in</span>
                            <span class="text-gray-800 font-thin">{{ new Date(reflectSelectedOrder.order.createdTime).toLocaleString() }}</span>
                        </div>
